...
{
    [TestCase("#123"), TestCase("#12345"), TestCase("#1234567"), TestCase("#123456789"), TestCase("gggggg"), TestCase("")]
    public void FromHex_Invalid_Throws(string hex)
    {
        Assert.Throws<ArgumentException>(() => LyColor.FromHex(hex));
    }

    [TestCase("#e8d7b0", 0xE8, 0xD7, 0xB0, 0xFF), TestCase("e8d7b0", 0xE8, 0xD7, 0xB0, 0xFF),
     TestCase("#e8d7b0cc", 0xE8, 0xD7, 0xB0, 0xCC), TestCase("e8d7b0cc", 0xE8, 0xD7, 0xB0, 0xCC)]

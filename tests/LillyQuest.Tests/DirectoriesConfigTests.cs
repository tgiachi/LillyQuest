...
public class DirectoriesConfigTests
{
    ...
    {
        var config = new DirectoriesConfig(_testRootDirectory, new[] { "Assets", "Config" });
    ...
    {
        var config = new DirectoriesConfig(_testRootDirectory, new[] { "Assets", "Config", "Data" });
    ...
    {
        var config = new DirectoriesConfig(_testRootDirectory, new Enum[] { DirectoryTypeEnum.Assets, DirectoryTypeEnum.Config });
    ...
    {
        var config = new DirectoriesConfig(_testRootDirectory, new string[] { });
    ...
    {
        var config = new DirectoriesConfig(_testRootDirectory, new[] { "Assets" });
    ...
    {
        var config = new DirectoriesConfig(_testRootDirectory, new Enum[] { DirectoryTypeEnum.Assets });
    ...
    {
        var config = new DirectoriesConfig(_testRootDirectory, new[] { "Assets_Textures_UI" });

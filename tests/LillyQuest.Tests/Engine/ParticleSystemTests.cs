...
public class ParticleSystemTests
{
    ...
    public void GetVisibleParticles_ReturnsOnlyParticlesInFOV()
    {
        ...
        // Particle in FOV
        system.Emit(new() { Position = new(5, 5), Lifetime = 1f });
        fovProvider.SetVisible(5, 5, true);

        // Particle outside FOV
        system.Emit(new() { Position = new(10, 10), Lifetime = 1f });
        fovProvider.SetVisible(10, 10, false);

        // Another particle in FOV
        system.Emit(new() { Position = new(6, 6), Lifetime = 1f });
        fovProvider.SetVisible(6, 6, true);
    ...
    public void ProcessEntities_DoesNotChangeParticleCount()
    {
        ...
        var fovProvider = new FakeFOVProvider();
        var system = new ParticleSystem(collisionProvider, fovProvider);
        system.Emit(new() { Lifetime = 2.0f });

        // Act
        system.ProcessEntities(
            new(TimeSpan.Zero, TimeSpan.FromSeconds(0.5)),
    ...
    public void Update_GravityBehavior_AcceleratesDownward()
    {
        ...
        {
            Position = new(10, 10),
            Velocity = new(0, 0), // Starting stationary
            Lifetime = 10f,
    ...
    public void Update_MovesParticlesByVelocity()
    {
        ...
        {
            Position = new(10, 20),
            Velocity = new(5, -10), // 5 pixels/sec right, 10 pixels/sec up
            Lifetime = 10f
        };
    ...
    public void Update_ParticleWithBounceFlag_ReflectsVelocityOnCollision()
    {
        // Arrange
        var collisionProvider = new FakeCollisionProvider();
        collisionProvider.SetBlocked(11, 20, true);
        ...
        {
            Position = new(10, 20),
            Velocity = new(10, 0), // Moving right
            Lifetime = 10f,
    ...
    public void Update_ParticleWithDieFlag_DiesOnCollision()
    {
        // Arrange
        var collisionProvider = new FakeCollisionProvider();
        collisionProvider.SetBlocked(11, 20, true); // Wall at destination
        ...
        {
            Position = new(10, 20),
            Velocity = new(10, 0), // Moving right, will reach x=11 in 0.1 sec
            Lifetime = 10f,
    ...
    public void Update_ParticleWithDieFlag_DoesNotDieWhenStayingInSameTile()
    {
        // Arrange
        var collisionProvider = new FakeCollisionProvider();
        collisionProvider.SetBlocked(10, 10, true);
    ...
    public void Update_ParticleWithoutDieFlag_StopsAtCollision()
    {
        ...
        {
            Position = new(10, 20),
            Velocity = new(10, 0), // Moving right towards wall
            Lifetime = 10f,
    ...
    public void Update_RemovesDeadParticles()
    {
        ...
        system.Emit(new() { Lifetime = 0.5f });
        system.Emit(new() { Lifetime = 2.0f });
        system.Emit(new() { Lifetime = 0.3f });

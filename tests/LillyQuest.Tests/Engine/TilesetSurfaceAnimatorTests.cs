...
public class TilesetSurfaceAnimatorTests
{
    ...
    public void EnqueueMove_ReturnsFalse_WhenDestinationOutOfBounds()
    {
        ...
        surface.SetTile(0, 0, 0, new(1, LyColor.White));
        var animator = new TilesetSurfaceAnimator(surface);

        var result = animator.EnqueueMove(0, new(0, 0), new(100, 0), 1.0f);
    ...
    public void EnqueueMove_ReturnsFalse_WhenSourceOutOfBounds()
    {
        ...
        var result = animator.EnqueueMove(0, new(-1, 0), new(1, 0), 1.0f);
    ...
    public void EnqueueMove_ReturnsFalse_WhenSourceTileEmpty()
    {
        ...
        var result = animator.EnqueueMove(0, new(0, 0), new(1, 0), 1.0f);
    ...
    public void ProcessMovements_AdvancesElapsedTime()
    {
        ...
        var animator = new TilesetSurfaceAnimator(surface);
        animator.EnqueueMove(0, new(0, 0), new(1, 0), 1.0f);

        animator.ProcessMovements(new(TimeSpan.Zero, TimeSpan.FromSeconds(0.5)));
    ...
    public void ProcessMovements_CompletesMovement_WhenDurationExceeded()
    {
        ...
        var animator = new TilesetSurfaceAnimator(surface);
        animator.EnqueueMove(0, new(0, 0), new(1, 0), 0.5f);

        animator.ProcessMovements(new(TimeSpan.Zero, TimeSpan.FromSeconds(1.0)));
    ...
    public void ProcessMovements_DoesNothing_WhenElapsedTimeIsZero()
    {
        ...
        animator.ProcessMovements(new(TimeSpan.Zero, TimeSpan.Zero));

...
namespace LillyQuest.Engine.Renderers;
...
public class SpriteBatch : IFontStashRenderer2, IDisposable
{
    ...
    {
        Draw(texture, position, size, ToLyColor(color), depth);
    }
    ...
    {
        Draw(texture, position, size, ToLyColor(color), rotation, depth);
    }
    ...
    {
        Draw(texture, position, size, ToLyColor(color), rotation, origin, depth);
    }
    ...
    {
        Draw(texture, position, size, ToLyColor(color), rotation, origin, sourceRect, depth);
    }
    ...
    {
        DrawCircle(center, radius, ToLyColor(color), segments, thickness, depth);
    }
    ...
    {
        DrawCircleFilled(center, radius, ToLyColor(color), depth);
    }
    ...
    {
        DrawLine(start, end, ToLyColor(color), thickness, depth);
    }
    ...
    {
        DrawPolygon(points, ToLyColor(color), thickness, depth);
    }
    ...
    {
        DrawPolygonFilled(points, ToLyColor(color), depth);
    }
    ...
    {
        DrawRectangle(position, size, ToLyColor(color), depth);
    }
    ...
    {
        DrawRectangleOutline(position, size, ToLyColor(color), thickness, depth);
    }
    ...
    {
        DrawTriangle(p1, p2, p3, ToLyColor(color), thickness, depth);
    }
    ...
    {
        DrawTriangleFilled(p1, p2, p3, ToLyColor(color), depth);
    }
    ...
    private static LyColor ToLyColor(FSColor color)

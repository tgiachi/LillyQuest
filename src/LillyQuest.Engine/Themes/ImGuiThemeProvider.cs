...
public static class ImGuiThemeProvider
{
    ...
    public static void ApplyCyanTheme()
    {
        ...
        style.Colors[(int)ImGuiCol.Tab] = new Vector4(0.00f, 0.50f, 0.50f, 0.33f);
        style.Colors[(int)ImGuiCol.TabHovered] = new Vector4(0.00f, 1.00f, 1.00f, 0.42f);
        style.Colors[(int)ImGuiCol.TabActive] = new Vector4(0.00f, 1.00f, 1.00f, 0.54f);
    }
    ...
    public static void ApplyDarkFantasyTheme()
    {
        ...
        style.Colors[(int)ImGuiCol.WindowBg] = new Vector4(0.10f, 0.10f, 0.15f, 1.00f);
        style.Colors[(int)ImGuiCol.ChildBg] = new Vector4(0.12f, 0.12f, 0.18f, 0.00f);
        style.Colors[(int)ImGuiCol.PopupBg] = new Vector4(0.08f, 0.08f, 0.12f, 0.95f);
        style.Colors[(int)ImGuiCol.Border] = new Vector4(0.42f, 0.26f, 0.36f, 0.65f);
        style.Colors[(int)ImGuiCol.BorderShadow] = new Vector4(0.00f, 0.00f, 0.00f, 0.00f);
        style.Colors[(int)ImGuiCol.FrameBg] = new Vector4(0.20f, 0.15f, 0.25f, 0.54f);
        style.Colors[(int)ImGuiCol.FrameBgHovered] = new Vector4(0.30f, 0.20f, 0.35f, 0.66f);
        style.Colors[(int)ImGuiCol.FrameBgActive] = new Vector4(0.42f, 0.26f, 0.36f, 0.80f);
        style.Colors[(int)ImGuiCol.TitleBg] = new Vector4(0.08f, 0.06f, 0.10f, 1.00f);
        style.Colors[(int)ImGuiCol.TitleBgActive] = new Vector4(0.42f, 0.26f, 0.36f, 0.87f);
        style.Colors[(int)ImGuiCol.TitleBgCollapsed] = new Vector4(0.08f, 0.08f, 0.12f, 0.75f);
        style.Colors[(int)ImGuiCol.MenuBarBg] = new Vector4(0.10f, 0.10f, 0.15f, 0.40f);
        style.Colors[(int)ImGuiCol.ScrollbarBg] = new Vector4(0.12f, 0.12f, 0.18f, 0.50f);
        style.Colors[(int)ImGuiCol.ScrollbarGrab] = new Vector4(0.83f, 0.69f, 0.22f, 0.44f);
        style.Colors[(int)ImGuiCol.ScrollbarGrabHovered] = new Vector4(0.83f, 0.69f, 0.22f, 0.74f);
        style.Colors[(int)ImGuiCol.ScrollbarGrabActive] = new Vector4(0.83f, 0.69f, 0.22f, 1.00f);
        style.Colors[(int)ImGuiCol.CheckMark] = new Vector4(0.83f, 0.69f, 0.22f, 1.00f);
        style.Colors[(int)ImGuiCol.SliderGrab] = new Vector4(0.83f, 0.69f, 0.22f, 0.50f);
        style.Colors[(int)ImGuiCol.SliderGrabActive] = new Vector4(0.83f, 0.69f, 0.22f, 1.00f);
        style.Colors[(int)ImGuiCol.Button] = new Vector4(0.42f, 0.26f, 0.36f, 0.60f);
        style.Colors[(int)ImGuiCol.ButtonHovered] = new Vector4(0.42f, 0.26f, 0.36f, 0.80f);
        style.Colors[(int)ImGuiCol.ButtonActive] = new Vector4(0.83f, 0.69f, 0.22f, 0.60f);
        style.Colors[(int)ImGuiCol.Header] = new Vector4(0.42f, 0.26f, 0.36f, 0.45f);
        style.Colors[(int)ImGuiCol.HeaderHovered] = new Vector4(0.42f, 0.26f, 0.36f, 0.80f);
        style.Colors[(int)ImGuiCol.HeaderActive] = new Vector4(0.83f, 0.69f, 0.22f, 0.50f);
        style.Colors[(int)ImGuiCol.Separator] = new Vector4(0.42f, 0.26f, 0.36f, 0.50f);
        style.Colors[(int)ImGuiCol.SeparatorHovered] = new Vector4(0.42f, 0.26f, 0.36f, 0.78f);
        style.Colors[(int)ImGuiCol.SeparatorActive] = new Vector4(0.83f, 0.69f, 0.22f, 0.75f);
        style.Colors[(int)ImGuiCol.ResizeGrip] = new Vector4(0.83f, 0.69f, 0.22f, 0.45f);
        style.Colors[(int)ImGuiCol.ResizeGripHovered] = new Vector4(0.83f, 0.69f, 0.22f, 0.78f);
        style.Colors[(int)ImGuiCol.ResizeGripActive] = new Vector4(0.83f, 0.69f, 0.22f, 1.00f);
        style.Colors[(int)ImGuiCol.Tab] = new Vector4(0.42f, 0.26f, 0.36f, 0.86f);
        style.Colors[(int)ImGuiCol.TabHovered] = new Vector4(0.42f, 0.26f, 0.36f, 0.80f);
        style.Colors[(int)ImGuiCol.TabActive] = new Vector4(0.83f, 0.69f, 0.22f, 0.50f);
        style.Colors[(int)ImGuiCol.TabUnfocused] = new Vector4(0.20f, 0.20f, 0.20f, 0.97f);
        style.Colors[(int)ImGuiCol.TabUnfocusedActive] = new Vector4(0.40f, 0.40f, 0.40f, 1.00f);
        style.Colors[(int)ImGuiCol.PlotLines] = new Vector4(0.29f, 0.49f, 0.62f, 1.00f);
        style.Colors[(int)ImGuiCol.PlotLinesHovered] = new Vector4(0.75f, 1.00f, 1.00f, 1.00f);
        style.Colors[(int)ImGuiCol.PlotHistogram] = new Vector4(0.83f, 0.69f, 0.22f, 1.00f);
        style.Colors[(int)ImGuiCol.PlotHistogramHovered] = new Vector4(1.00f, 0.88f, 0.40f, 1.00f);
        style.Colors[(int)ImGuiCol.TextSelectedBg] = new Vector4(0.42f, 0.26f, 0.36f, 0.35f);
        style.Colors[(int)ImGuiCol.DragDropTarget] = new Vector4(0.83f, 0.69f, 0.22f, 0.90f);
        style.Colors[(int)ImGuiCol.NavHighlight] = new Vector4(0.83f, 0.69f, 0.22f, 1.00f);
        style.Colors[(int)ImGuiCol.NavWindowingHighlight] = new Vector4(0.83f, 0.69f, 0.22f, 0.70f);

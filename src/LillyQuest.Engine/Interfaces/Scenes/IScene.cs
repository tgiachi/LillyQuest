...
/// Scenes contain entities and manage their lifecycle during scene transitions.
/// </summary>
public interface IScene
{
    ...
    /// </summary>
    IEnumerable<IGameEntity> GetSceneGameObjects();
    ...
    /// </summary>
    /// <param name="gameObjectManager">Game object manager used to register globals.</param>
    void RegisterGlobals(IGameEntityManager gameObjectManager);
}
